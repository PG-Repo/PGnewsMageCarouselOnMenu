...
// Card View Display properties 
  public get data(): IImageCardParameters {
    return {
      primaryText: this.state.PGnewsCarouselFirstIndexView ? this.state.PGnewsCarouselFirstIndexView[0].title +": "+ this.state.PGnewsCarouselFirstIndexView[0].newsDescription.substring(0, 140) + '...' : `Title or Description Missed`,
      imageUrl: this.state.PGnewsCarouselFirstIndexView[0].pgCarouselImage ? this.state.PGnewsCarouselFirstIndexView[0].pgCarouselImage : require('../assets/MicrosoftLogo.png'),
      title: "PG Daily News"
