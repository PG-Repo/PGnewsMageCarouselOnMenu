 ...
 onLoadSitePageURL : "https://pgonedev.sharepoint.com/_api/Web/Lists/GetByTitle('Site Pages')/Items?$select=ID,CanvasContent1,PGImage,FileRef,Title,PGLocation,NewsDescription,PGNewsImage,ExternalLink&$filter=PGLocation ne null&$orderby=Modified desc&$top=15",
